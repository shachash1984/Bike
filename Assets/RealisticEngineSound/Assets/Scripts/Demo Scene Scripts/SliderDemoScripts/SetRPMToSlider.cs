...
public class SetRPMToSlider : MonoBehaviour {
    ...
    RealisticEngineSound controllerScript;
    ...
    private void Start()
    {
        controllerScript = controllerGameobject.GetComponent<RealisticEngineSound>();
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            controllerScript.gasPedalPressing = carSimulator.gasPedalPressing;
            rpmSlider.value = carSimulator.rpm;
            gasPedalCheckbox.isOn = carSimulator.gasPedalPressing;
        }
    }
    public void GasPedalCheckbox() // press gas pedal
    {
        if (controllerScript != null)
        {
            if (controllerScript.gasPedalPressing) // turn off gas pedal pressing
                controllerScript.gasPedalPressing = false;
            else
                controllerScript.gasPedalPressing = true;
        }
    }
